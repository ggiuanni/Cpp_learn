...
int StringToNumber(string MyString)
{
    ...
    // Contains the operation restults
    int result;
...
string NumberToString(int Number)
{
    ...
    // Perform the conversion and return to results
    converter << Number;
...
int main()
{
    // Contains the theorical number of kids
    float NumberOfKids;
    ...
    of kids to a real number by trunvating NumberOfKids
    ...
    */
    ...
    // Perfomr the same task as before, but use a
