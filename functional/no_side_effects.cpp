          ...
          const int Start, const int End)
{
    ...
    // Copy the full vector to a verctor of the
    // correct size
...
int main()
{
    ...
    cout << "Sum of All Elements: " << AddIt(ThisVector, 0, ThisVector.size()) << endl;

    cout << "Sum of Elements 1 through 4: " << AddIt(ThisVector, 1, 5) << endl;
