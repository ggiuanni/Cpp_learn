/**
 * @file map_compare.cpp
 * @author Giovanni Cassone (giovanni.csn@gmail.com)
 * @brief Containing Instances and Needing Functions That Compare Them
 * @version 0.1
 * @date 2024-10-09
 *
...
public:
    string Nickname;
    string SSN;
    Emp(string anickname, string asocial) : Nickname(anickname),
                                            SSN(asocial) {}
    Emp() : Nickname(""), SSN("") {}
};
...
public:
    int YearlyInc;
    int Taxes;
    Salary(int aannual, int adeductions) : YearlyInc(aannual),
                                           Taxes(adeductions) {}
